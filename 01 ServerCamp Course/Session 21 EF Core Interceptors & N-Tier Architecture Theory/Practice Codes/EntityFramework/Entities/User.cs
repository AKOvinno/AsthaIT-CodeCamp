...
public class User
{
    ...
    public List<Order>? UserOrders { get; set; } // This is a navigation property that represents the one-to-many relationship between User and Order. A User can have multiple Orders, but each Order is associated with only one User.
}